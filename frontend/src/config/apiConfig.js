...
export const IMAGES_PATH = import.meta.env.VITE_BACKEND_URL + "storage/";
export const API_SANCTUM_URL = import.meta.env.VITE_SANCTUM_URL;
export const CHECK_TOKEN_URL = "check-token";
export const ACCOUNT_URL = "accounts";
export const COST_URL = "costs";
export const COMPANY_URL = "companies";
export const COMPANY_URL_PARAMENTER = "companies/";
export const INVOICE_URL = "invoices";
export const INVOICE_URL_PARAMETER = "invoices/";
export const INVOICE_URL_QUERY = "invoices?";
export const INVOICE_COUNT = "invoices/totalInvoices";
...
export const OPPORTUNITY_URL_PARAMETER = "opportunities/";
export const OPPORTUNITY_COUNT = "opportunities/totalOpportunities";
export const OPPORTUNITY_OPEN_URL = "opportunities/open";

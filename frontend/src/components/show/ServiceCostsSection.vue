    ...
    <div class="section-container">
        ...
        <div class="table-row" v-for="localCost in localCosts" v-bind:key="localCost.id"
            ...
            <div class="price-column">
                <money-field name="price" v-model="localCost.pivot_price" />
            </div>
            <div class="total-price-column">
                <money-field name="total_price" v-model="localCost.pivot_total_price" />
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        addProposalCostCreated({ serviceCosts, newTotalThirdPartyCost }) {
            serviceCosts.forEach(newCost => {
    ...
    watch: {
        service: {
            handler(newService) {
                this.localCosts = newService.costs;
            },
            deep: true,
        },
    },
